...
<html>
<head>
<title>Sport-Way | Login | Find Your Sport Journey</title>
...
<div class="banner-top">
	<div class="container">
		<h3 >Login</h3>
		<h4><a href="<?php echo base_url()."index.php/web/index"; ?>">Home</a><label>/</label>Login</h4>
	...
	<div class="login">
		...
		<div class="main-agileits">
				...
				<div class="forg">
					...
					<a href="<?php echo base_url()."index.php/auth/register"; ?>" class="forg-right">Register</a>
				<div class="clearfix"></div>
				</div>
			</div>
		</div>
