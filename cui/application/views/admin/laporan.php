   ...
   <div class="x_content">
      <div class="row">
         ...
         <div class="col-md-1 col-sm-12 col-md-offset-1">
            <a href="<?= base_url(); ?>transadm/cetak/<?= $bln; ?>/<?= $thn; ?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i></a>
         </div>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <span style="float:right"><?= number_format($key->total_pembelian, 0, ',', '.'); ?>,-</span>
                     </td>
                     <td>
                        <span style="float:left">Rp.</span>
                        <span style="float:right"><?= number_format($key->total_pembelian - $key->biaya, 0, ',', '.'); ?>,-</span>
                     </td>
                     <td>
                        <span style="float:left">Rp.</span>
